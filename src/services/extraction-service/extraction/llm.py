...
EXTRACTION_PROMPT = """Extract the following fields from this Florida business document
(Articles of Incorporation, Annual Report, or similar).
    ...
    def extract(
        ...
        try:
            ...
            all_field_names = [
                ...
                "principal_address", "mailing_address", "officers"
            ]
